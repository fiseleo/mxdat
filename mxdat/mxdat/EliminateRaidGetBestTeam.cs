...
namespace mxdat
{
    ...
    {
        public static void EliminateRaidGetBestTeamMain(string EliminateRaidGetBestTeamUserID)
        {
            ...
            int SearchAccountId = int.Parse(EliminateRaidGetBestTeamUserID);
            ...
            {
                string RaidFolderPath = Path.Combine(Directory.GetCurrentDirectory(), "EliminateRaidOpponentList");
                string ExtractAccountIdAndNicknamePath = Path.Combine(RaidFolderPath, "EliminateRaidOpponentListUserID&Nickname.json");
                try
                {
                ...
                string responseFilePath = Path.Combine(jsonFolderPath, $"EliminateRaidGetBestTeam{SearchAccountId}.json");
